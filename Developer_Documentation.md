...
For Middlemarch (200,000 words ≈ 1M characters):

- **TTS**: ~$15 for full book generation
- **Character Analysis**: ~$1-3 for all character processing
- **Total**: ~$18-20 per book generation

### Cloudflare R2 Costs

1. **Storage**:
   - $0.015 per GB/month for stored data
   - Example: 1GB of audio files = $0.015/month

2. **Bandwidth**:
   - $0.085 per GB for data egress (downloads)
   - Example: 100GB downloaded = $8.50

3. **Requests**:
   - $0.35 per 1M requests
   - Usually negligible for typical usage

### GitHub Pages Costs

- Free hosting for static files
- CDN distribution globally
- No bandwidth charges for visitors

### Total Monthly Costs Estimation

For a production deployment with 100GB storage and 1TB monthly bandwidth:

- **R2 Storage**: $1.50 (100GB)
- **R2 Bandwidth**: $85.00 (1TB)
- **R2 Requests**: $0.01 (negligible)
- **GitHub Pages**: $0.00 (free)
- **OpenAI API**: Variable (depends on TTS usage)

**Total**: ~$86.50/month + OpenAI costs

### Cost Optimization Strategies

1. **Audio Compression**:
   - Use appropriate bit rates (64-128kbps for speech)
...
3. **Request Optimization**:
   - Combine small files where possible
   - Implement efficient playlist loading

4. **API Usage Monitoring**:
   - Monitor OpenAI usage closely
   - Consider pre-generating content instead of on-demand
